...
static void ledgateway_mci1_hw_init(void){
...
static void ledgateway_mci2_hw_init(void){
	at91_set_a_periph(AT91_PIO_PORTC, 10, 0);       /* MCI2 CMD */
	at91_set_a_periph(AT91_PIO_PORTC, 11, 0);       /* MCI2 DA0 */
	at91_set_a_periph(AT91_PIO_PORTC, 12, 0);       /* MCI2 DA1 */
	at91_set_a_periph(AT91_PIO_PORTC, 13, 0);        /* MCI2 DA2 */
	at91_set_a_periph(AT91_PIO_PORTC, 14, 0);        /* MCI2 DA3 */
	at91_set_a_periph(AT91_PIO_PORTC, 15, 0);        /* MCI2 CLK */

	/* enable the clock */
	at91_periph_clk_enable(ATMEL_ID_MCI2);
}
...
int board_init(void)
{
	...
	ledgateway_mci1_hw_init();
	ledgateway_mci2_hw_init();
#endif
	return 0;
}
...
int board_mmc_init(bd_t *bis)
{
	...
	atmel_mci_init((void *)ATMEL_BASE_MCI2);
